...
#define LightGreen		 0x97B0
#define Cachi					 0xCF2E
#define Orange				 0xDE05
#define DeepOrange		 0xD4A2
#define DarkRed				 0xB820
/******************************************************************************
...
void drawRect(int x0,int y0,int lunghezza,int altezza,uint16_t color);
